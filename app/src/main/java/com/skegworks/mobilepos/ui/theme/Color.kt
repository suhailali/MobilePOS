...
// Salwariya Colors (Blue Theme)
val salwariyaPrimaryLight = Color(0xFF0061A4)
val salwariyaOnPrimaryLight = Color(0xFFFFFFFF)
val salwariyaPrimaryContainerLight = Color(0xFFD1E4FF)
val salwariyaOnPrimaryContainerLight = Color(0xFF001D36)

val salwariyaPrimaryDark = Color(0xFF9ECAFF)
val salwariyaOnPrimaryDark = Color(0xFF003258)
val salwariyaPrimaryContainerDark = Color(0xFF00497D)
val salwariyaOnPrimaryContainerDark = Color(0xFFD1E4FF)

// Constants for contrast variants (kept original names to avoid breaking imports if any)
